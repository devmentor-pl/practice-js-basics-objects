...
books.getTitle = function (isbn, lang) {
  ...
  if (typeof this[isbn].title[lang] === "undefined") return null;
...
books.getTranslator = function (isbn, lang) {
  if (typeof this[isbn] === "undefined") return null;
  if (typeof this[isbn].translator[lang] === "undefined") return null;
...
// console.log(books.getTitle("000-00-0000-000-0")); // null
