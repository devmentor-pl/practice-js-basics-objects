...
books.getTitle = function(isbn, lang) {
	if (typeof this[isbn] === 'undefined') return null;
	return lang ? this[isbn]['title'][lang] : null;
};

books.getTranlator = function(isbn, lang = false) {
	if (typeof this[isbn] === 'undefined') return null;
	if (this[isbn]['translator'][lang]) return this[isbn]['translator'][lang];
	if (this[isbn]['translator'][lang] == null) return false;
};
