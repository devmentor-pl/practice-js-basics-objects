...
books.getTitle = function (isbn, lang) {
    ...
    if(typeof this[isbn]['title'] === 'undefined' || typeof this[isbn]['title'][lang] === 'undefined') {
        return null;
    }
...
books.getTranslator = function (isbn, lang) {
    ...
    if(typeof this[isbn]['translator'] === 'undefined' || typeof this[isbn]['translator'][lang] === 'undefined') {
        return null;
    }
