...
books.getTitle = function(isbn, lang) {
    return (typeof this[isbn] === 'undefined' || typeof this[isbn]['title'][lang] === 'undefined') ? null : this[isbn]['title'][lang];
    
}

books.getTranslator = function(isbn, lang) {
    return (typeof this[isbn] === 'undefined' || typeof this[isbn]['translator'][lang] === 'null') ? false : this[isbn]['translator'][lang];
